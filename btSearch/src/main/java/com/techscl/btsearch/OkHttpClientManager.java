...
/**
 * Created by songchunlin 2016年5月17日 上午9:24:45
 */
public class OkHttpClientManager {
    ...
    /*public static void postAsyn(String url, final ResultCallback callback, Map<String, Object> params,boolean e) {
        getInstance()._po;
    }*/
    ...
    public static void postAsyn(String url, final ResultCallback callback, String json) {
                ...
                if (callback != null) {
                    try {
                        ...
                        if (object.toString().length() > 0) {
                            ...
                            callback.onError(null, new Exception("数据异常"));
                        }
    ...
    private Request buildPostRequest(String url, Param[] params) {
        ...
        /*if(url.indexOf("postReferralInfo") > -1 || url.indexOf("postRewindInfo") > -1){
            requestBody = RequestBody.create(MediaType.parse("application/json"), string);
        }else{
            requestBody = RequestBody.create(MediaType.parse("application/x-www-form-urlencoded"), string);
        }*/
        return new Request.Builder().url(url).post(requestBody).build();
    }
